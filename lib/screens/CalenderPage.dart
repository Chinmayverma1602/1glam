...
class _CalendarPageState extends State<CalenderPage> {
  ...
  final Map<DateTime, List<Booking>> _bookings = {
    // Today's date will be calculated dynamically
    // Example bookings for specific dates
    DateTime(2025, 3, 19): [
      Booking('Priya Shah', 'Bridal Makeup', '10:00 AM - 12:00 PM', BookingStatus.pending),
      Booking('Meera Kapoor', 'Party Makeup', '2:30 PM - 4:00 PM', BookingStatus.confirmed),
    ],
    DateTime(2025, 3, 20): [
      Booking('Aisha Khan', 'Evening Makeup', '5:00 PM - 6:30 PM', BookingStatus.confirmed),
    ],
    DateTime(2025, 3, 21): [
      Booking('Riya Patel', 'Wedding Makeup', '9:00 AM - 11:30 AM', BookingStatus.pending),
      Booking('Neha Sharma', 'Natural Makeup', '1:00 PM - 2:00 PM', BookingStatus.confirmed),
      Booking('Tina Joshi', 'Photoshoot Makeup', '4:00 PM - 6:00 PM', BookingStatus.pending),
    ],
  };

  // Get bookings for a specific date
  List<Booking> _getBookingsForDay(DateTime day) {
    // Normalize date to compare only year, month, and day
    final normalizedDay = DateTime(day.year, day.month, day.day);
    
    // Return bookings for the selected day or empty list if none
...
class Booking {
  ...
  Booking(this.name, this.service, this.time, [this.status = BookingStatus.pending]);
}